...
class ParallaxView: UIView {
    ...
    override func didMoveToSuperview() {
        ...
        scrollView.addObserver(self.parent, forKeyPath: NSStringFromSelector(#selector(getter: scrollView.contentOffset)), options: .new, context: parallaxHeaderKVOContext)
    }
 ...
 */
    ...
    var scrollView : UIScrollView! {
        ...
        set(scrollView) {
            guard let scrollView = scrollView, scrollView != _scrollView else { return }
