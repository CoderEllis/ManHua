...
class LBUPageController: LBUBaseController {
    ...
    lazy var pageVC : UIPageViewController = {
       return UIPageViewController(transitionStyle: .scroll, navigationOrientation: UIPageViewController.NavigationOrientation.horizontal, options: nil) 
    }()
...
extension LBUPageController: UIPageViewControllerDelegate, UIPageViewControllerDataSource {
