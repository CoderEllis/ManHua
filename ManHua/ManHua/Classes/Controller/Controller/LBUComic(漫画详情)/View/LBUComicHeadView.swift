...
class LBUComicHeadView: UIView {
    private lazy var bgView: UIImageView = {
        ...
        bgView.blurView.setup(style: .extraLight, alpha: 1).enable()
        return bgView
    }()
    ...
    var detailRealtime: LBUComicRealtimeModel? {
        didSet {
            ...
            text.insert(NSAttributedString(string: " \(detailRealtime.click_total ?? "0") ", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 15), NSAttributedString.Key.foregroundColor: UIColor.orange]), at: 2)
            
            text.append(NSAttributedString(string: " \(detailRealtime.favorite_total ?? "0") ", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 15), NSAttributedString.Key.foregroundColor : UIColor.orange]))
